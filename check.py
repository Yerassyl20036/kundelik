...
def automate(driver_path, username, password, class_name):
    try:
        ...
        screenshot_path = os.path.join(screenshot_directory, f'{username}.png')
        driver.save_screenshot(screenshot_path)
        print(f"Screenshot saved for username: {username}")
...
if __name__ == "__main__":
    ...
    excel_path = os.path.join(current_directory, 'ЖООfull.xlsx')
